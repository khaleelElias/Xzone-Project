                ...
                <div className="p-10">
                    <div className="space-y-0">
                        <img src="/images/logo.png" loading="lazy"
                            className="w-30"/>
                        <h2 className="mb-6 text-1xl text-cyan-900 dark:text-white font-bold">Thank You for Placing a PIXslip. Resaluts will be announced on X
                        </h2>
                    </div>
                        ...
                        <button
                            ...
                            <div className="relative flex items-center space-x-4 justify-center">
                                <img src="/images/x.jpg"
                                    className="absolute left-0 w-5" alt="X logo" />
                                <span
                                    className="block w-max font-semibold tracking-wide text-gray-700 dark:text-white text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">
                                    Follow US On X
                                </span>
                            </div>
                        </button>
